...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL) || empty($subject) || empty($body_text)) {
        ...
        header('Location: phpmailer_attach.php');
        exit;
    }
    ...
    try {
        ...
        $mail->send();
        $_SESSION['alert'] = ['type' => 'success', 'text' => 'Сообщение с вложением отправлено через PHPMailer!'];
    } catch (Exception $e) {
...
<head>
    ...
    <title>PHPMailer - Сообщение с вложением</title>
            ...
            <div class="col-12 col-lg-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h2 class="section-title mb-4">Отправка с <span class="highlight">вложением</span></h2>
                        <p class="text-muted mb-4">PHPMailer - сообщение с прикрепленным файлом</p>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary w-100">Отправить с вложением</button>
                        </form>
